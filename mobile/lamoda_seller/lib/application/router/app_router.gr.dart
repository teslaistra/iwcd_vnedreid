...
class AddBrandRoute extends PageRouteInfo<void> {
  const AddBrandRoute({List<PageRouteInfo>? children})
    : super(AddBrandRoute.name, initialChildren: children);
...
class BrandRoute extends PageRouteInfo<void> {
  const BrandRoute({List<PageRouteInfo>? children})
    : super(BrandRoute.name, initialChildren: children);
...
/// generated route for
/// [SuccessSentPage]
class SuccessSentRoute extends PageRouteInfo<void> {
  const SuccessSentRoute({List<PageRouteInfo>? children})
    : super(SuccessSentRoute.name, initialChildren: children);

  static const String name = 'SuccessSentRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const SuccessSentPage();
    },
  );
}
