...
part 'onboarding_page_theme.g.dart';

@ThemeExtended()
class OnboardingPageTheme with _$OnboardingPageTheme {
  const factory OnboardingPageTheme({
    @ThemeProperty()
  ...
  }) = _OnboardingPageTheme;
}

abstract class OnboardingPageColors {
